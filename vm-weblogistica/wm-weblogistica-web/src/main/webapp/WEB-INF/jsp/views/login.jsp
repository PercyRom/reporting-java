	        ...
	        <form id="form-login" action="<c:url value='j_spring_security_check' />" method="post">
	          <div class="form-group">
	            <div class="form-label-group">
	              <input type="email" id="username" class="form-control" placeholder="Ingrese su usuario" required="required" autofocus="autofocus" name="username"/>
	              <label for="username">Usuario</label>
	            </div>
	          </div>
	          <div class="form-group">
	            <div class="form-label-group">
	              <input type="password" id="password" class="form-control" placeholder="Ingrese su clave" required="required" name="password" />
	          ...
	          --%>
	          <a class="btn btn-primary btn-block btn-login" onclick="fnIniciarSesion()">Acceder</a>
	        </form>
	        <%-- 
